...
```javascript
FLOAT32_SIGN_MASK = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-sign-mask@v0.1.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/constants-float32-sign-mask/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/constants-float32-sign-mask/actions/workflows/test.yml?query=branch:v0.1.0
